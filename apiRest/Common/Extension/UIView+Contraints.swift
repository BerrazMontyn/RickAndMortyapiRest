...
extension UIView {
    ...
    func setConstraints ( //añado los contrains manual, uno por uno.
        ...
        translatesAutoresizingMaskIntoConstraints = false //esta propiedad tiene que ir siempre en false para que acepte los contrains
    ...
    func setHeightConstrain(with heigth: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
        heightAnchor.constraint(equalToConstant: heigth).isActive = true
    }
    
    func setWidthConstrain(with width: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
